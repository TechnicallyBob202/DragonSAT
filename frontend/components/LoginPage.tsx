  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 flex flex-col items-center justify-center p-4">
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl w-full max-w-md overflow-hidden">
        {/* Header */}
        <div className="px-5 md:px-8 pt-6 md:pt-8 pb-6 text-center border-b border-gray-100 dark:border-gray-700">
        ...
        {/* Form */}
        <form onSubmit={handleSubmit} className="px-5 md:px-8 py-6 space-y-4">
          {error && (
        ...
        {tab === 'register' && (
          <p className="px-5 md:px-8 pb-6 text-xs text-gray-500 dark:text-gray-400 text-center">
      ...
      <a
        ...
        className="mt-4 inline-flex items-center gap-1.5 text-sm text-gray-400 dark:text-gray-500 hover:text-pink-500 dark:hover:text-pink-400 transition-colors"
      >
        <span>💖</span>
