...
export function Dashboard() {
  ...
  return (
    <div className="p-4 md:p-8">
      ...
      {/* Stats Strip */}
      {userStats && (
        <div className="grid grid-cols-2 md:flex items-center mb-10 p-3 bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
        {MODES.map((modeCard) => (
          <button
            ...
            className="group relative overflow-hidden rounded-2xl p-5 md:p-8 text-white shadow-lg transition-all hover:scale-[1.02] hover:shadow-xl active:scale-100"
          >
            {/* Gradient Background */}
            ...
            <div className="relative z-10 text-left">
              <div className="text-4xl md:text-6xl mb-4">{modeCard.icon}</div>
...
function Divider() {
  return <div className="hidden md:block w-px h-10 bg-gray-100 dark:bg-gray-700 flex-shrink-0" />;
}
